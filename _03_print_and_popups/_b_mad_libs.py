...
if __name__ == '__main__':
    ...
    adj = simpledialog.askstring(title= "Question", prompt= "Enter an adjective")
    # Get the player to enter a type of liquid
    liq = simpledialog.askstring(title= "Question", prompt= "Ender a liquid")
    # Get the player to enter a body part
    body = simpledialog.askstring(title="Question", prompt="Ender a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title="Question", prompt="Enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title="question",prompt="Ender a place")
